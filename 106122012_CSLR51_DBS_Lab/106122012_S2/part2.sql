...
(1, 'Ameya', 'CSE', 'DBMS', 'OS', 'DS', 'Maths'),
(2, 'Aditya', 'ECE', 'Signals', 'Networks', 'Electronics', 'Maths'),
(3, 'Pawan', 'MECH', 'Thermo', 'Fluid', 'Mechanics', 'Maths'),
(4, 'Sharv', 'CIVIL', 'Structures', 'Geo', 'Hydraulics', 'Maths'),
(5, 'Tanush', 'EEE', 'Circuits', 'EMF', 'Power', 'Maths');
